...
export function BottomNav() {
  ...
  return (
    <motion.div 
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-[var(--bolt-bg-depth-2)]/90 backdrop-blur-xl border-t border-[var(--bolt-border-color)] z-40 flex items-center px-4 pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.2)]"
    >
        ...
        {MOBILE_NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              <item.icon size={22} className={cn("relative z-10 transition-transform duration-300", isActive && "scale-110")} />
            </Link>
          );
        })}
      </div>
